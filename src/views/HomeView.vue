<template>
 <!-- Introduction -->
  <section class="mb-8 py-20 text-white text-center relative">
    ...
    <img alt="Background" class="relative block mx-auto mt-5 -mb-20 w-auto max-w-full"
...
export default {
  ...
  methods: {
    handleScroll() {
      ...
      const bottomWinidow = Math.round(scrollTop) + innerHeight === offsetHeight;
